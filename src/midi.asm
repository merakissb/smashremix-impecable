...
scope MIDI {
    ...
    insert_midi(TRUNKS_BATTLE_V1, OS.TRUE, OS.TRUE, "Trunks Battle V1", butouden3, 902)
    insert_midi(TRUNKS_BATTLE_V2, OS.TRUE, OS.TRUE, "Trunks Battle V2", butouden3, 903)
    insert_midi(RHYTMICAL_BUSTLE, OS.TRUE, OS.TRUE, "Rhythmical Bustle", meltyblood, 904)
    ...
    insert_midi(BALROG_STAGE, OS.TRUE, OS.TRUE, "Balrog's Stage", ssf2, 911)
    insert_midi(RYU_STAGE, OS.TRUE, OS.TRUE, "Ryu's Stage", ssf2, 912)
